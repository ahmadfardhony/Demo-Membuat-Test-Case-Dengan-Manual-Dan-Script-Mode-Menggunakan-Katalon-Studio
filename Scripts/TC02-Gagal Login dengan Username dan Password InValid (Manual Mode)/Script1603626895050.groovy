...
'Masukkan Invalid Username'
WebUI.setText(findTestObject('OrangeHRM - Object/Page_OrangeHRM/input_LOGIN Panel_txtUsername'), 'User')

'Masukkan Invalid Password'
WebUI.setText(findTestObject('OrangeHRM - Object/Page_OrangeHRM/input_Username_txtPassword'), 'User123')
